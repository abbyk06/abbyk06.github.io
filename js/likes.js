...
const SVG_EMPTY = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
const SVG_FILLED = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
async function handleLike() {
    ...
    try {
        ...
        btn.innerHTML = SVG_FILLED;
        btn.classList.add("pop");
        setTimeout(() => {
            btn.classList.remove("pop");
            btn.innerHTML = SVG_EMPTY;
        }, 500);
    } catch {
